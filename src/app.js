...
const template_path = path.join(__dirname, "../templates/views");//File Path to integrate templates with path
const partials_path = path.join(__dirname, "../templates/partials");//File Path to integrate partials with path
